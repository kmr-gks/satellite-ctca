...
!     --------------- electromagnetic field:
      ...
      if(ifxyz(EX).ge.1) then
        ...
        if(func.eq.0) then
          write(grname,'(a)') 'ex'
          write(plhdfn,'(a,a,i2.2,a,i4.4,a)') 'requester-data/',trim(grname),istep/i1hdf,'_',nfsnap,'.h5'
...
!
        if(ipaxyz(1,is).ge.1) then
          ...
          if(func.eq.0) then
            write(grname,'(a)') 'xe'
            write(plhdfn,'(a,i1,a,i2.2,a,i4.4,a)') 'requester-data/p',is,trim(grname),istep/i3hdf,'_',nfsnap,'.h5'
            call hdfopen_pg(plhdfn,grname,id_sd(1,h5ind),id_sd(2,h5ind),DFACC_CREATE,MCW)
            if(id_sd(1,h5ind).le.0) then
