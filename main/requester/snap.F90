...
!-------------------- write the ES-snap data into a file
      if(myid.eq.0) &
     &  write(6,*) 'write ES-snapshot data into requester-SNAP1'
      write(filename,'(a,a,i4.4,a)') 'requester-SNAP1/','esdat', myid, '.h5'
...
!
      ...
      if(myid.eq.0) then
        write(filename,'(a,a)') 'requester-SNAP1/','cpcmtx.h5'
        call hdfopen(filename,fileid,DFACC_CREATE)
!
        dsname = 'cpmx'
